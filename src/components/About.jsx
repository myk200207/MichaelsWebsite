...
const About = () => {
  return (
    <>
      <section id="AboutPage" className="h-screen flex flex-row text-center text-white">
        <div className="flex flex-col flex-1 w-10 justify-center items-center px-20">
          <h1 className="text-5xl font-bold mb-4">About Me</h1>
          <h2 className="text-2xl">Michael Kim</h2>
          <br />
          <p className="mb-3 px-40">
            I have proudly served in the United States Air Force as a Medic working with the 55th Medical Group in Omaha, Nebraska, and the 367th Expeditionary Group in Doha, Qatar.
          </p>
          <p className="mb-3 px-40">
        ...
        <div
          className="flex flex-col flex-1 justify-center items-center pt-16"
